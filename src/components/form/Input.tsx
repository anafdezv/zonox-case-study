            ...
            <div className="w-full flex flex-col gap-2">
                ...
                <div className="w-full relative flex items-center">
                    <input
                        ...
                        disabled={disabled}
                        value={defaultValue}
                        className={`w-full rounded-lg px-3 py-2 border shadow-sm placeholder-gray-500 focus:outline-none focus:border-blue-300 active:border-blue-300 disabled:bg-gray-50 ${
