            ...
            <div className="w-full flex flex-col gap-2 justify-center items-center">
                <div className="flex items-center gap-3">
                    <label className="inline-flex gap-2 items-center cursor-pointer">
                        <span
                            className={`text-sm font-medium ${defaultValue === true ? 'text-gray-600' : 'text-blue-600'} ${showLabel ? '' : 'sr-only'}`}
                        >
                            {label[0]}
                        </span>{' '}
                        <input
                        ...
                        <span
                            className={`text-sm font-medium peer-checked:text-blue-600 text-gray-600 ${showLabel ? '' : 'sr-only'}`}
                        >
                            {label[1]}
                        </span>{' '}
                    </label>
